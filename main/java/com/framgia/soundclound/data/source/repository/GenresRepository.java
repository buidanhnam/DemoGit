...
public @interface ServiceName {
    ...
    public static List<Genres> getListGenres() {
        List<Genres> genres = new ArrayList<>();
        genres.add(new Genres(R.string.genres_all, R.drawable.img_background_genres,
                GENRES_ALL,
                R.drawable.icon_music_all));
        genres.add(new Genres(R.string.genres_pop, R.drawable.img_background_genres,
                GENRES_POP,
                R.drawable.icon_music_pop));
        genres.add(new Genres(R.string.genres_country, R.drawable.img_background_genres,
                GENRES_COUNTRY,
                R.drawable.icon_music_country));
        genres.add(new Genres(R.string.genres_classic, R.drawable.img_background_genres,
                GENRES_CLASSIC,
                R.drawable.icon_music_classic));
        genres.add(new Genres(R.string.genres_depp_house, R.drawable.img_background_genres,
                GENRES_DEEP_HOUSE,
                R.drawable.icon_music_deephouse));
        genres.add(new Genres(R.string.genres_popblas, R.drawable.img_background_genres,
                GENRES_POP_BLAS,
                R.drawable.icon_music_popblast));
        genres.add(new Genres(R.string.genres_rock, R.drawable.ic_favorite_gray_24dp,
                GENRES_ROCK,
                R.drawable.icon_music_roock));
        genres.add(new Genres(R.string.genres_edm, R.drawable.ic_favorite_gray_24dp,
                GENRES_EDM,
                R.drawable.icon_musicedm));
        genres.add(new Genres(R.string.genres_electronic, R.drawable.ic_favorite_gray_24dp,
                GENRES_ELECTRONIC,
                R.drawable.icon_musicedm));
        return genres;
    }
