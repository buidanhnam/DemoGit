...
//    @BindingAdapter("config_size")
//    public static void resize(ConstraintLayout viewLayout, String resource) {
//        int h_view = calculateItemHight(viewLayout.getContext());
//        int w_view = calculateItemWith(viewLayout.getContext());
//        viewLayout.requestLayout();
//        viewLayout.setLayoutParams(new ConstraintLayout.LayoutParams(w_view, h_view));
//
//    }
